...
@section ('content_main')
   <!-- Modal -->
   <div class="modal fade" id="entidadModal" role="dialog">
 ...
 <div class="container">
   <!-- Modal -->
   <div class="modal fade" id="entidadesModal" role="dialog">
    <div class="modal-dialog">
 ...
 $(document).ready( function () {
     $.ajaxSetup({
      ...
      var table =  $('#laravel_datatable_entidades').DataTable({
...
// Función de botón ver gráfico de segmentación x lados.
  ...
  $('#laravel_datatable_entidades').DataTable().draw(true);
  });
