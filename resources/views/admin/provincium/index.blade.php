                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'codigo'">{{ trans('admin.provincium.columns.codigo') }}</th>
                                        <th is='sortable' :column="'nombre'">{{ trans('admin.provincium.columns.nombre') }}</th>
                                        <th is='sortable' :column="'fecha_desde'">{{ trans('admin.provincium.columns.fecha_desde') }}</th>
                                        <th is='sortable' :column="'fecha_hasta'">{{ trans('admin.provincium.columns.fecha_hasta') }}</th>
                                        <th is='sortable' :column="'observacion_id'">{{ trans('admin.provincium.columns.observacion_id') }}</th>
                                        <th is='sortable' :column="'geometria_id'">{{ trans('admin.provincium.columns.geometria_id') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        <td>@{{ item.codigo }}</td>
                                        <td>@{{ item.nombre }}</td>
                                        <td>@{{ item.fecha_desde | date }}</td>
                                        <td>@{{ item.fecha_hasta | date }}</td>
