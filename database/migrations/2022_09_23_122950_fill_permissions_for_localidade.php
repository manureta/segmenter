...
class FillPermissionsForLocalidade extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLocalidade constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.localidade',
            'admin.localidade.index',
            'admin.localidade.create',
            'admin.localidade.show',
            'admin.localidade.edit',
            'admin.localidade.delete',
            'admin.localidade.bulk-delete',
        ]);
