...
class FillPermissionsForDepartamento extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDepartamento constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.departamento.show',
            'admin.departamento.edit',
            'admin.departamento.delete',
            'admin.departamento.bulk-delete',
        ]);
