...
class FillPermissionsForTipoDeRadio extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTipoDeRadio constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tipo-de-radio',
            'admin.tipo-de-radio.index',
            'admin.tipo-de-radio.create',
            'admin.tipo-de-radio.show',
            'admin.tipo-de-radio.edit',
            'admin.tipo-de-radio.delete',
            'admin.tipo-de-radio.bulk-delete',
        ]);
